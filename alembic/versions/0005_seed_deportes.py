...
DEPORTES_SEED = [
    ...
    {
        "slug": "rollers",
        "nombre_es": "Patinaje agresivo / rollers",
    ...
    {
        "slug": "patinaje_velocidad",
        "nombre_es": "Patinaje de velocidad",
        "nombre_en": "Speed skating",
        "categoria": "urbano",
        ...
        "spots_colombia": [
            "Velodromo Alberto Galindo Cali",
            "Pista San Carlos Medellin",
        ],
        "referentes_colombia": [
            "Cecilia Baena",
            "Pedro Causil",
    ...
    {
        "slug": "patinaje_artistico",
        "nombre_es": "Patinaje artistico",
        "nombre_en": "Artistic skating",
        "categoria": "urbano",
    ...
    {
        "slug": "scooter",
        "nombre_es": "Scooter freestyle",
        "nombre_en": "Scooter freestyle",
        "categoria": "urbano",
        "escena_co": "Bogota, Medellin",
        "plataforma_externa": "instagram",
    ...
    {
        "slug": "parkour",
        "nombre_es": "Parkour / Freerunning",
        "nombre_en": "Parkour / Freerunning",
        "categoria": "urbano",
        "escena_co": "Bogota, Medellin",
        "plataforma_externa": "instagram",
        "vocabulario": [
    ...
    {
        "slug": "sup",
        "nombre_es": "Stand-up Paddle (SUP)",
        "nombre_en": "Stand-up Paddle",
        "categoria": "urbano",
    ...
    {
        "slug": "slacklining",
        "nombre_es": "Slacklining / Highline",
        "nombre_en": "Slacklining",
        "categoria": "urbano",
        "escena_co": "Suesca, Bogota, San Gil",
        "plataforma_externa": "instagram",
    ...
    {
        "slug": "climbing",
        "nombre_es": "Escalada deportiva / boulder",
        "nombre_en": "Sport climbing / bouldering",
        "categoria": "escalada",
    ...
    # ===== COMBATE =====
    {
        ...
        "nombre_en": "Boxing",
        "categoria": "combate",
        "escena_co": "Todo el pais (Yuberjen Martinez, Ceiber Avila)",
        "plataforma_externa": "instagram",
        "vocabulario": [
            "jab",
            "cross",
    ...
    },
    {
        ...
        "nombre_en": "Muay Thai",
        "categoria": "combate",
        "escena_co": "Bogota, Medellin, Cali",
        "plataforma_externa": "instagram",
        "vocabulario": [
            "jab",
            "low kick",
    ...
    {
        "slug": "bjj",
        "nombre_es": "Brazilian Jiu-Jitsu",
        "nombre_en": "Brazilian Jiu-Jitsu",
        "categoria": "combate",
    ...
    },
    {
        ...
        "nombre_en": "Taekwondo",
        "categoria": "combate",
        "escena_co": "Todo el pais (Yuri Alvear medalla olimpica)",
        "plataforma_externa": "instagram",
        "vocabulario": [
            "dolyo chagi",
            "naeryeo chagi",
    ...
    {
        "slug": "kickboxing",
        "nombre_es": "Kickboxing / K-1",
        "nombre_en": "Kickboxing",
        "categoria": "combate",
        "escena_co": "Bogota, Medellin",
        "plataforma_externa": "instagram",
        "vocabulario": [
    ...
    {
        "slug": "wrestling",
        "nombre_es": "Lucha (libre/grecorromana)",
        "nombre_en": "Wrestling",
        "categoria": "combate",
    ...
    # ===== EQUIPO =====
    {
        ...
        "nombre_en": "Soccer",
        "categoria": "equipo",
        "escena_co": "Todo el pais (deporte rey)",
        "plataforma_externa": "instagram",
        "vocabulario": [
            "gol",
            "asistencia",
    ...
    {
        "slug": "baloncesto",
        "nombre_es": "Baloncesto",
        "nombre_en": "Basketball",
        "categoria": "equipo",
    ...
    {
        "slug": "voley_playa",
        "nombre_es": "Voleibol playa",
        "nombre_en": "Beach volleyball",
        "categoria": "equipo",
    ...
    },
    {
        ...
        "nombre_en": "Baseball",
        "categoria": "equipo",
        "escena_co": "Costa Caribe (Cartagena, Barranquilla)",
        "plataforma_externa": "instagram",
        "vocabulario": [
            "bate",
            "strike",
        ...
        "referentes_colombia": [
            "Caimanes Cartagena (50a edicion LCBP)",
            "Diego Contreras",
        ],
    ...
    {
        "slug": "hockey",
        "nombre_es": "Hockey (campo/sala/linea)",
        "nombre_en": "Hockey",
        "categoria": "equipo",
    ...
    },
    {
        ...
        "nombre_en": "Padel",
        "categoria": "equipo",
        "escena_co": "Bogota, Medellin, Cali (500+ canchas 2025, FCP oficializada)",
        "plataforma_externa": "instagram",
    ...
    {
        "slug": "running",
        "nombre_es": "Running de calle",
        "nombre_en": "Road running",
        "categoria": "outdoor_endurance",
    ...
    {
        "slug": "trail",
        "nombre_es": "Trail running / Ultra",
        "nombre_en": "Trail running",
        "categoria": "outdoor_endurance",
    ...
    {
        "slug": "ocr",
        "nombre_es": "OCR / Spartan / carrera obstaculos",
        "nombre_en": "OCR",
        "categoria": "outdoor_endurance",
        "escena_co": "Bogota (Spartan), Pereira",
        "plataforma_externa": "instagram",
        "vocabulario": [
            "obstaculo",
            "spear throw",
    ...
    {
        "slug": "mtb",
        "nombre_es": "Mountain bike (XC/DH/enduro)",
        "nombre_en": "Mountain bike",
        "categoria": "outdoor_endurance",
    ...
    {
        "slug": "ciclismo",
        "nombre_es": "Ciclismo de ruta / pista",
        "nombre_en": "Road cycling",
        "categoria": "outdoor_endurance",
    ...
    {
        "slug": "atletismo",
        "nombre_es": "Atletismo (pista/campo)",
        "nombre_en": "Athletics",
        "categoria": "outdoor_endurance",
    ...
    {
        "slug": "gimnasio",
        "nombre_es": "Gimnasio (musculacion general)",
        "nombre_en": "Gym (strength)",
    ...
    {
        "slug": "calistenia",
        "nombre_es": "Calistenia",
        "nombre_en": "Calisthenics",
        "categoria": "indoor_fuerza",
        "escena_co": "Parques (Simon Bolivar, Pereira)",
        "plataforma_externa": "instagram",
        "vocabulario": [
            "muscle up",
            "front lever",
    ...
    {
        "slug": "powerlifting",
        "nombre_es": "Powerlifting",
        "nombre_en": "Powerlifting",
        "categoria": "indoor_fuerza",
        "escena_co": "Todo el pais (escena emergente)",
        "plataforma_externa": "instagram",
        "vocabulario": [
            "squat",
            "bench",
    ...
    {
        "slug": "halterofilia",
        "nombre_es": "Halterofilia / Olympic lifting",
        "nombre_en": "Olympic weightlifting",
        "categoria": "indoor_fuerza",
    ...
    {
        "slug": "funcional",
        "nombre_es": "Funcional / HIIT",
        "nombre_en": "Functional / HIIT",
        "categoria": "indoor_fuerza",
        "escena_co": "Todo el pais",
        "plataforma_externa": "instagram",
        "vocabulario": [
    ...
    },
    {
        ...
        "spots_colombia": ["Estudios Bogota"],
        "referentes_colombia": [],
        "federacion": "",
    },
    {
    ...
    {
        "slug": "pole",
        "nombre_es": "Pole dance / pole sport",
        "nombre_en": "Pole dance",
        "categoria": "indoor_fuerza",
        "escena_co": "Bogota, Medellin, Cali",
        "plataforma_externa": "instagram",
        "vocabulario": [
        ...
        "spots_colombia": ["Estudios pole Bogota"],
        "referentes_colombia": [],
        "federacion": "",
    },
    {
        "slug": "aerial",
        "nombre_es": "Aerial silks / lyra",
        "nombre_en": "Aerial arts",
        "categoria": "indoor_fuerza",
        "escena_co": "Bogota, Medellin",
        "plataforma_externa": "instagram",
        ...
        "spots_colombia": ["Circo del Sol Bogota"],
        "referentes_colombia": [],
        "federacion": "",
    },
    # ===== ACUATICO =====
    {
        ...
        "nombre_en": "Swimming",
        "categoria": "acuatico",
        "escena_co": "Medellin, Cali, Bogota",
        "plataforma_externa": "strava",
        "vocabulario": [
            "crawl",
            "espalda",
    ...
    },
    {
        ...
        "spots_colombia": ["Piscinas"],
        "referentes_colombia": [],
        "federacion": "Fecna",
    },
    {
        "slug": "apnea",
        "nombre_es": "Buceo libre / Apnea",
        "nombre_en": "Freediving",
        "categoria": "acuatico",
    ...
    {
        "slug": "buceo",
        "nombre_es": "Buceo con tanque (scuba)",
        "nombre_en": "Scuba diving",
        "categoria": "acuatico",
        "escena_co": "San Andres, Santa Marta, Cartagena",
        "plataforma_externa": "instagram",
    ...
    {
        "slug": "equitacion",
        "nombre_es": "Equitacion (salto/doma/CC)",
        "nombre_en": "Equestrian",
        "categoria": "ecuestre",
    ...
    {
        "slug": "caballo_paso",
        "nombre_es": "Caballo de paso fino colombiano",
        "nombre_en": "Paso Fino",
        "categoria": "ecuestre",
    ...
    # ===== MOTOR =====
    {
        ...
        "spots_colombia": ["Autodromo Tocancipa"],
        "referentes_colombia": [],
    ...
    {
        "slug": "enduro_moto",
        "nombre_es": "Enduro moto",
        "nombre_en": "Enduro motorcycle",
        "categoria": "motor",
    ...
    {
        "slug": "tejo",
        "nombre_es": "Tejo (deporte nacional)",
        "nombre_en": "Tejo",
        ...
        "referentes_colombia": [],
        "federacion": "Federacion Colombiana de Tejo",
    },
    {
        "slug": "coleo",
        "nombre_es": "Coleo (llanos orientales)",
        "nombre_en": "Coleo",
        "categoria": "tradicional_co",
